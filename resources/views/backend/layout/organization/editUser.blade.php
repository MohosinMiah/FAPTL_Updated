...
<a href="{{ route( 'organization_info' ) }}" class="btn btn-danger"> Clinic Info  Setting</a>
<br>
<br>
	<div class="row">
		@if(session('status'))
...
<hr>
		...
		<div class="col-md-12">
			...
			<form method="post" action="{{ route('organization_update_user', $data['user']->id) }}" enctype="multipart/form-data">
				@csrf
